...
public class Stalk {
	...
	public static double stalkLookAtThreshold = 0.98;	// The threshold at which the player will be considered looking at Herobrine. -1.0 is directly oppsotie, 1.0 is directly towards
